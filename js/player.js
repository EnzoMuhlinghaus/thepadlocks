var Player = function() {
  ...
  var ui = {
    ...
    options: {
      random: '.options__bttn--random',
      playlist: '.options__bttn--playlist',
      activeClass: 'options__bttn--active'
    },
    info: {
      title: '.player__title',
    ...
    controls: {
      prev: '.controls__bttn--prev',
      next: '.controls__bttn--next',
      play: {
        playPause: '.controls__bttn--play-pause',
