...
$( ".player-wrap" ).each(function() {
  ...
  if (jsPlayer) {
    jsPlayer = {
      wrap: jsPlayer,
      player: jsPlayer.querySelector(id + ' audio'),
      wrapList: (document.querySelector(id + ' .playlist-wrap') || {}),
      currentTime: (jsPlayer.querySelector(id + ' .current-time') || {}),
      durationTime: (jsPlayer.querySelector(id + ' .duration-time') || {}),
      seekBar: (jsPlayer.querySelector(id + ' .seek-bar') || { style: {} }),
      bigPlayButton: (jsPlayer.querySelector(id + ' .big-play-button') || { style: {} }),
      bigPauseButton: (jsPlayer.querySelector(id + ' .big-pause-button') || { style: {} }),
      playButton: (jsPlayer.querySelector(id + ' .play-button') || { style: {} }),
      pauseButton: (jsPlayer.querySelector(id + ' .pause-button') || { style: {} }),
      prevButton: (jsPlayer.querySelector(id + ' .prev-button') || { style: {} }),
      nextButton: (jsPlayer.querySelector(id + ' .next-button') || { style: {} }),
      playlistButton: (jsPlayer.querySelector(id + ' .playlist-button') || { style: {} }),
      titleText: (jsPlayer.querySelector(id + ' .title-text') || { style: {} }),
      artistText: (jsPlayer.querySelector(id + ' .artist-text') || { style: {} }),
      seekInterval: null,
      trackCount: 0,
      playing: false,
      playlist: [],
